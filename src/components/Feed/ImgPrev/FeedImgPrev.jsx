...
export default function PostImgPrev({ onImageUrlChange }) {
  ...
  window.console.log('maek', uploadPreview);
  const handleUploadImg = async (e) => {
    ...
    window.console.log('!!!', uploadedFileObjects, uploadedFileUrls);
  };
  ...
  const drop = (e) => {
    ...
    window.window.console.log('드래그', imgFile, imgUrl);
